...
const d = {
  ...
  mem: { total: 7.6, used: 6.6, free: 1.01, usage: 86.75 },
  jvm: {
    total: 698.5,
    max: 910.5,
    free: 388.87,
    version: "1.8.0_172",
    home: "/usr/local/jdk/jdk1.8.0_172/jre",
    used: 309.63,
    usage: 44.33,
    startTime: "2021-01-08 18:11:07",
    runTime: "3天16小时11分钟",
    name: "Java HotSpot(TM) 64-Bit Server VM",
  },
  sys: {
    computerName: "sjqkl-tsvm04",
    computerIp: "127.0.0.1",
    userDir: "/opt/hzdl/kkFileView-2.2.1/log",
    osName: "Linux",
    osArch: "amd64",
  },
  sysFiles: [
