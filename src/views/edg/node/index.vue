  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="数据id" prop="evidenceId">
        <el-input
          v-model="queryParams.evidenceId"
          placeholder="请输入数据id"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="数据状态" prop="evidenceStatus">
        <el-select v-model="queryParams.evidenceStatus" placeholder="请选择数据状态" clearable size="small">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['edg:node:export']"
        >导出</el-button>
      </el-col>
	  <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="nodeList" @selection-change="handleSelectionChange" stripe>
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="主键" align="center" prop="id" />
      <el-table-column label="数据状态" align="center" prop="evidenceStatus" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="数据状态">
          <el-select v-model="form.evidenceStatus" placeholder="请选择数据状态" style="width:100%">
            <el-option label="请选择字典生成" value="" />
          </el-select>
        </el-form-item>
...
<script>
import { listNode, getNode, delNode, addNode, updateNode, exportNode } from "@/api/edg/node";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除数据节点编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有数据节点数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
