<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="共享名称" prop="fileName">
        <el-input
      ...
      <el-form-item label="共享描述" prop="evidenceType">
        <el-input
      ...
      <el-form-item label="共享方" prop="evidenceType">
        <el-input
          v-model="queryParams.evidenceType"
          placeholder="请输入共享方"
          clearable
      ...
      <el-form-item>
        <el-button type="primary"   @click="handleQuery">完成创建</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table v-loading="loading" :data="exceptionList" @selection-change="handleSelectionChange" stripe>
      ...
      <el-table-column label="电量" align="center" prop="evidenceTypeName" />
      <el-table-column label="电压" align="center" prop="optType" />
